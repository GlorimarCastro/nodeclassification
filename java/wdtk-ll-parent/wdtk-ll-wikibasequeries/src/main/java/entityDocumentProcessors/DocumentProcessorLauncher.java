		...
		switch(documentProcessortouse){
			case 1:								//entityDescriptionDcumentProcessor
				...
				if(isArgumentPass){
					...
					EntityDescriptionDocumentProcessor documentProcessor = new EntityDescriptionDocumentProcessor(input[1]);
					...
					EntityDescriptionDocumentProcessor documentProcessor = new EntityDescriptionDocumentProcessor(scanner.nextLine());
					ExampleHelpers.processEntitiesFromWikidataDump(documentProcessor);
			...
			case 2:								//entityIdtoStringDocumentProcessor
				EntityIdToStringDocumentProcessor documentProcessor = new EntityIdToStringDocumentProcessor(new File(input[0]));
				ExampleHelpers.processEntitiesFromWikidataDump(documentProcessor);
				documentProcessor.closeWriter();
				break;
			default:
				break;
		}
